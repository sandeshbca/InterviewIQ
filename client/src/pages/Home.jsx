          ...
          <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-ms'>
                Start Interview
              </motion.button>
              <motion.button
                onClick={() => {
                ...
                whileHover={{ opacity: 0.5, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.9 }}
                className='border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition shadow-ms'>
                View History
              </motion.button>
            </div>
          </div>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                },
                {
                  ...
                  desc: "Dynamic follow-up quetions based on your answers."
                },
                {
                  icon: <BsClock size={24} />,
                  step: "STEP 3",
                  title: "Timer Based Simulation",
                  desc: "Real interview pressure with time traking."
                }
              ].map((item, index) => (
