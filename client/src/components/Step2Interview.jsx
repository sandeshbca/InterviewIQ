...
import { FaMicrophone, FaMicrophoneSlash, FaWindowMaximize } from "react-icons/fa";
...
export default function Step2Interview({ interviewData, onFinish }) {
  ...
  const [isIntrophase, setIaIntroPhase] = useState(true);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200">
          ...
          <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5">
            ...
            <div className="flex justify-center">
              <Timer timerLeft={timeLeft} totalTime={currentQuestion?.timeLimit} />
            </div>
        ...
        <div className="flex-1 flex flex-col p-4 sm:p-6 mb:p-8 relative">
          ...
          <textarea
            ...
            value={answer}
            className="flex-1 bg-gray-100 p-4 sm:p-6 rounded-2xl resize-non
e outline-none border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition text-gray-800"
          />
        ...
        <motion.button
          ...
          {isMicOn ?  <FaMicrophone size={20} />: <FaMicrophoneSlash  size={20}/>}
           ...
           to-teal-500 text-white py-3 sm:py-4 disabled:bg-gray-500 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold"
            >
