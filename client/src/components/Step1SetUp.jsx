    ...
    <motion.div
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        <motion.div
          ...
          className='relative bg-gradient-to-br from-green-50 to-gray-100 p-12 flex flex-col justify-center'>
              ...
              <motion.div
                ...
                {skills.length > 0 && (
                  <div>
                    ...
                    <div className='list-disc list-inside text-gray-600 space-y-1'>{skills.map((s, i) => (
