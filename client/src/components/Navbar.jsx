      ...
      >
        ...
        <div className="flex items-center gap-6 relative">
          <div className="relative">
            ...
            {showCreditPopup && (
              <div className="absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border rounded-lg p-5 z-50">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center justify-center w-9 h-9 bg-black rounded-full text-white"
            >
              {userData ? (
            ...
            {showUserPopup && (
              <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border rounded-xl p-4 z-50">
                ...
                <button
                  ...
                  className="w-full text-left py-2 flex items-center gap-2 text-red-500"
                >
